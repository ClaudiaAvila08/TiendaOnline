                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            File file = new File("C:\\Users\\claud\\Downloads\\updated2\\TiendaOnline\\web\\img\\Productos" + fileItem.getName());
                            fileItem.write(file);
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            ...
                            if (!"".equals(nomfoto)) {
                                File file = new File("C:\\Users\\claud\\Downloads\\updated2\\TiendaOnline\\web\\img\\fotoUser" + fileItem.getName());
                                fileItem.write(file);
                    ...
                    if (listausuarios.size() == 6) {
                        cli.setId(idcliente);
                        cli.setDui(listausuarios.get(0));
