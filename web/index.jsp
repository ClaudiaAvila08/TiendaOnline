    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="nav-item dropdown">
                <a class="navbar-brand" style="color: white" href="#" data-toggle="dropdown"><img src="img/logo.png" width="60" height="60"> EMPRE_SV</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./Controlador?accion=Oferta"><i class="fas fa-plus-circle" style="color: white"></i> Ofertas </a>
                    </li>                   
                    <li class="nav-item">
                ...
                <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                    ...
                    <div class="dropdown-menu text-center dropdown-menu-right">
                        <c:if test="${clientelogueado.id==null||clientelogueado.id==0}">
                            <a class="dropdown-item" href="#"><img src="img/fotoUser/user1.png" width="60" height="60"/></a>                        
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="text-center">                             
                                    <img src="${pageContext.request.contextPath}/img/logo.png" width="60" height="60">
                                    <img src="${pageContext.request.contextPath}/${p.getImagen()}" style="height: 150px;width:90%; padding: 10px">
