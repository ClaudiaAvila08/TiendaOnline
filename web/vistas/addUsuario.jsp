<%-- 
    Document   : addUsuario
    Created on : 11-09-2024, 03:31:08 PM
    Author     : claud
--%>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand"  href="#"><i><img src="img/logo.png" width="50" height="40"></i> EMPRE_SV</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" id="dui" name="txtDui" class="form-control" placeholder="46184659">
                            </div>                                                   
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="txtDir" class="form-control" placeholder="Av. San Salvador">
                            </div>                                                   
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
        ...
        <script>
            $(document).ready(function () {
                var input = document.getElementById('dui');
