...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <a class="navbar-brand" href="#"><i>EMPRE_SV</i></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                    ...
                    <div class="dropdown-menu text-center dropdown-menu-right">
                        <a class="dropdown-item" href="#"><img src="img/fotoUser/user1.png" alt="60" height="60"/></a>                        
                ...
                <div class="container col-lg-9">                   
                    <div class="modal-content">                   
                        ...
                        <div class="text-center">                         
                             <img src="img/fotoUser/user1.png" width="100" height="100">                          
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input type="text" name="txtnom" class="form-control" placeholder="Sofia Perez">
                                        </div>
                                        <div class="form-group">
                                            <label>Dui</label>
                                            <input type="number" name="txtdui" class="form-control" placeholder="01245678">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input type="text" name="txtdire" class="form-control" placeholder="La Victoria">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" name="txtemail" class="form-control" placeholder="email@example.com">
