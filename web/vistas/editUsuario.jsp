<%-- 
    ...
    Created on : 11-09-2024, 04:32:19 PM
    Author     : claud
--%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="dui" name="txtDui" value="${cliente.dui}" class="form-control" placeholder="46184659">
                    </div>                                                   
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="txtDir" value="${cliente.direccion}" class="form-control" placeholder="Av. San Salvador">
                    </div>                                                   
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
